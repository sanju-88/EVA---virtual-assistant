...
function Signup() {
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{ backgroundImage: `url(${bg})` }}>
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000066] backdrop-blur-md shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] rounded-lg px-[30px]' onSubmit={handleSignup}>

        <h1 className='text-3xl text-white font-semibold text-center mt-10 mb-[30px]'>Register to <span className='text-blue-400'>virtual assistant</span></h1>
        <input type="text" name='name' placeholder='Enter your name' className='w-full h-[60px] outline-none border-2 border-white bg-transparent text-white placeholder:text-gray-300 px-[20px] rounded-full text-[18px]' required onChange={(e) => setName(e.target.value)} value={name} />
