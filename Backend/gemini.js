...
{
  "type": "general | google_search | youtube_search | get_time | get_date | get_day | get_month | calculator_open | instagram_open | facebook_open",
...
INTENT DETECTION:
- "general" → facts, questions, conversation
